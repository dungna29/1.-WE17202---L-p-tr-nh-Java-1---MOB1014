...
public class B1_LyThuyet_OOP {
    ...
    1. Định nghĩa:
        Lập trình hướng đối tượng (Object Oriented Programing – OOP) là đưa các đối tượng có trong thế giới thực (Sinh Viên, ô tô, chó, mèo, người, hoa......) vào trong lập trình để thao tác với các Đối Tượng(thêm,sửa,xóa....) hoặc với các THUỘC TÍNH(Thông tin) của đối tượng. Ngoài ra đối tượng còn có các hành động và luôn phải là động từ thì trong lập trình nó sẽ là Method hay còn gọi là phương thức của đối tượng.
