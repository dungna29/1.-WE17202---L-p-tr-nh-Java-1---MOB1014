...
public class S2_KhaiBaoBien {
  /*
    *********** Biến khái niệm cơ bản ***********
    Định nghĩa: Biến dùng để lữu trữ giá trị
    Công thức: <kiểu dữ liệu> <tên biến> [=giá trị khởi đầu];
    <kiểu dữ liệu>: Định nghĩa kiểu dữ liệu cho biến
    <tên biến>: Dùng để phân biệt giữa các tên biến với nhau và có phân biệt chữ hoa chữ thường
